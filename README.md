...
### 💡 Examples <a name="examples"></a>
 ...
 - Training SMP model with [Pytorch-Lightning](https://pytorch-lightning.readthedocs.io) framework for cell motility segmentation <a href="https://githubtocolab.com/mberkay0/segmentation_models.pytorch/blob/master/examples/cell_motility_segmentation.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open in Colab"/></a>
